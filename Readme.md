...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *LambdaGitHubWebhook*):

Restore dependencies
```
    cd "LambdaGitHubWebhook"
    dotnet restore
```

Execute unit tests
```
    cd "LambdaGitHubWebhook/test/LambdaGitHubWebhook.Tests"
    dotnet test
```

Deploy application
```
    cd "LambdaGitHubWebhook/src/LambdaGitHubWebhook"
